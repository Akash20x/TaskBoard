...
function getSavedColumns() {
  if (localStorage.getItem('todoItems')) {
    ...
    todoListArray = ['Write an article'];
    progressListArray = ['Work on projects', 'Review Code'];
    completeListArray = ['Learn React', 'Watch a lecture'];
    onHoldListArray = ['Jogging'];
  }
}
...
function drop(e) {
  ...
  // remove background color amd padding
